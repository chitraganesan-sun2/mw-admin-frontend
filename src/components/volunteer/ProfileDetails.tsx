...
const VolunteerProfileDetails = () => {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () =>
      (
        await GET_API(
          endpoints.volunteer.getVolunteerDetails(volunteerId || "")
        )
      ).data,
    enabled: !!volunteerId,
  });
  ...
  const profileDetails = [
    {
      title: "Name",
      value: getValue(volunteerDetails?.name),
      rootClassName: "col-span-2",
    },
    {
      title: "Gender",
      value: getFormattedValue(volunteerDetails?.gender),
  ...
  const legalInformations = [
      ...
      data: [
        {
          ...
          value:
            volunteerDetails?.criminal_background_check_details
        ...
        },
        {
          title: "Description",
          value:
            volunteerDetails?.criminal_background_check_details?.description,
        },
      ],
    },
    {
      ...
      data: [
        {
          ...
          value:
            volunteerDetails?.sex_offender_check_details
      ...
      data: [
        {
          ...
          value:
            volunteerDetails?.disciplinary_check_details
        ...
        },
        {
          ...
          value:
            volunteerDetails?.disciplinary_check_details?.involved_in_disputes,
        },
        {
          title:
      ...
      data: [
        {
          ...
          value:
            volunteerDetails?.health_and_safety_check_details
    ...
    },
    {
      ...
      data: [
        {
          title:
            "Do you consent to a criminal background check, including child abuse registry and sex offender checks?",
          value:
    ...
    },
    {
      ...
      data: [
        {
          title:
            "Have you previously volunteered with children or vulnerable populations?",
          value:
            volunteerDetails?.volunteer_experience_details
              ?.previously_volunteered,
        },
        {
          title:
  ...
  const consentPermissions = [
    ...
    },
    {
      ...
      value: volunteerDetails?.privacy_policy_accepted,
    },
    {
      title: "Do you acknowledge the terms & conditions?",
      value: volunteerDetails?.terms_and_conditions_accepted,
    },
  ];
        ...
        <div>
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {profileDetails.map((item, index) => (
                <div
                  key={index}
                  className={`flex flex-col gap-1 ${item?.rootClassName || ""}`}
                >
          ...
          <div className="border-t mt-5 pt-5">
            <Collapse
              ...
              expandIcon={({ isActive }) => (
                <CaretRightOutlined
                  className="text-gray-medium !text-lg"
                  ...
                  {legalInformations.map((item, index) => (
                    <div key={index} className="flex flex-col gap-2 pt-3">
                      ...
                      {item?.data?.map((field) => (
                        <div
                          className={
                            field?.title === "Description" && !field?.value
                              ? "hidden"
                              : ""
                          }
                        >
