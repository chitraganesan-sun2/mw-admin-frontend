...
// robots/index metadata don't matter for this internal, auth-walled console, but the
// title is still what shows in the browser tab.
export const metadata: Metadata = {
    title: "Page Not Found | MelodyWings Admin",
};
